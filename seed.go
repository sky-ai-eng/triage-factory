...
func seedDefaultPrompts(prompts db.PromptStore, blueprints db.BlueprintStore, handlers db.EventHandlerStore) {
	...
	if err := db.SeedTeamDefaults(ctx, prompts, blueprints, handlers,
		runmode.LocalDefaultOrg, runmode.LocalDefaultTeamID, ai.ShippedPrompts(), ai.ShippedBlueprints()); err != nil {
