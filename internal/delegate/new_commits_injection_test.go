...
func TestHandlePRNewCommits_TerminalNonResumableSkips(t *testing.T) {
	...
	if _, err := s.conversations.CompleteSystem(context.Background(), runmode.LocalDefaultOrgID, "run-finished", "completed", 0, 0, 0, "", string(domain.ConversationOutcomeFinish), "", ""); err != nil {
