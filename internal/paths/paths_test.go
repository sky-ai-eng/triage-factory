...
func TestResolvers_LocalLayout(t *testing.T) {
	...
	cases := []struct{ name, got, want string }{
		...
		{"CuratorSharedReposRoot", CuratorSharedReposRoot(realOrg), filepath.Join("/s", "curator-repos")},
		{"CuratorSharedRepoDir", CuratorSharedRepoDir(realOrg, "octo", "cat"), filepath.Join("/s", "curator-repos", "octo", "cat")},
...
func TestResolvers_MultiLayout(t *testing.T) {
	...
	cases := []struct{ name, got, want string }{
		...
		{"CuratorSharedReposRoot", CuratorSharedReposRoot(realOrg), filepath.Join(orgBase, "curator-repos")},
		{"CuratorSharedRepoDir", CuratorSharedRepoDir(realOrg, "octo", "cat"), filepath.Join(orgBase, "curator-repos", "octo", "cat")},
