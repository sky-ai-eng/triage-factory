...
// covers SetSession/SetWorktreePath and the two boundary doors, but not the
// terminal, which has no app-pool door — RunConversationReturnedRowConformance,
// on the admin pool, covers CompleteForClaimSystem instead. Every claims-row
