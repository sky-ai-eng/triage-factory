...
func newRunSignalStore() db.RunSignalStore { return runSignalStore{} }

var _ db.RunSignalStore = runSignalStore{}

func (runSignalStore) Insert(context.Context, string, string, domain.RunSignalKind, string, string) (int64, error) {
	return 0, db.ErrNotApplicableInLocal
}

func (runSignalStore) ListUnackedForTarget(context.Context, string) ([]domain.RunSignal, error) {
