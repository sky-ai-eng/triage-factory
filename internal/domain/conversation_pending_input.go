...
// message text a user sent to a parked/terminal-resumable conversation, recorded
// before the conversation's SAME row is re-queued as ordinary claimable work. The
