...
func TestSynthesizeCuratorTurns_DerivesCostAndTokensFromMessages(t *testing.T) {
	...
	messages := []domain.Message{
		...
		{ID: 4, ConversationID: "conv", Role: "user", Content: "second turn",
