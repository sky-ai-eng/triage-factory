...
| `TRIAGE_FACTORY_JIRA_INREVIEW_STATUS` | The single in-review status — where a ticket goes while the agent's pull request awaits a human. Optional; unset leaves such a ticket in the in-progress status. |
