...
- **Self-host (Tier 3):** the operator enables the browser profile and sets their
  ...
  posture (`docs/isolation-tiers.md`).
...
The SKY-254 perf benchmark (`docs/specs/sky-254-perf-benchmark/results.md`)
...
- `docs/specs/sky-254-runsc-validation/` — the sandbox the browser runs in;
