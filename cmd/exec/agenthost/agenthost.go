...
type RunInfo struct {
	...
	// strings) — non-secret. A curator turn creates no run_worktrees
	...
	// the run_worktrees ledger unchanged.
...
type Client interface {
	...
	// the directory as the HOST filesystem knows it (what run_worktrees rows
	...
	// arbitrary repo. Callers should reserve the run_worktrees row BEFORE
