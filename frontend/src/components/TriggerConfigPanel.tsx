        ...
        <>
          ...
          >
            ...
            <div className="px-5 pt-5 pb-3 border-b border-border-subtle shrink-0">
              ...
              {sourceUnavailable && (
                <p className="text-[11px] text-text-tertiary italic mt-2">
              ...
              <div className="flex items-center gap-2">
                {readOnly ? (
                  <>
                    ...
                    <button
                      onClick={onClose}
                      className="text-[12px] font-medium text-white bg-accent hover:bg-accent/90 px-4 py-1.5 rounded-lg transition-colors"
                    >
                      Close
                    </button>
                  </>
