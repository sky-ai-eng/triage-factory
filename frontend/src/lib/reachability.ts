...
// is one canonical form. The backend stores the github/jira base URL verbatim
// (and the reachability probe trims only internally), so without this an
// untrimmed value would pass the probe yet get persisted with stray
// whitespace/slash and break identity lookups or the App/PAT/Jira flows.
