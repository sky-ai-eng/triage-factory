...
// ingested message — an @mention or an engaged-thread follow-up — to a TF
// user via a verified-email match against the auth-principal bridge, so a
// later leaf (TFAC-510/511) can grant that user run-visibility and render
// audit attribution. Capture infrastructure only
