...
// administration. Any failure 404-and-hides (non-disclosure) — an unlicensed or
// non-operator caller must not learn the console exists. Returns nil when it has
// already written the response; the caller returns immediately on nil.
